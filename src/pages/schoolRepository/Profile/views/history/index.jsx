  ...
  return (
    <s.Container>
      ...
      <p>
        ...
        and home to a rich variety of cultures, people and entertainment. It is
        home to the impressive National Library of Wales: one of few places to
        contain a copy of every book ever printed in the UK.
      </p>

      <p>
        For international students, we offer generous Scholarships covering the
        cost of your accommodation, as well as free gym membership, visa and
        immigration advice, careers support and transport to Aberystwyth upon
        arrival to the UK.
      </p>
    </s.Container>
  );
