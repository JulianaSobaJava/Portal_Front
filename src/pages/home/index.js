    ...
    <Container>
      ...
      <style.SearchContainer>
        <style.Search>
          ...
          <style.InputSearch>
            <Icons.FaSearch />
            <input placeholder="Insira o nome de uma escola" type="text" />
          </style.InputSearch>
          ...
          <div>
            ...
            <style.FilterOPtions>
              {filterOptions.map((item) => (
                <style.FiltersGroups click={click} key={item.id}>
            ...
            return (
              <style.Box>
                ...
                <style.BoxContent>
                  ...
                  <style.LinkButton to={item.link}>Ver Perfil</style.LinkButton>
                </style.BoxContent>
              </style.Box>
            );
          })}
      ...
      <style.FutureContainer>
        <style.FutureContent>
          <style.FutureDescripion>
            ...
            <p>
              Esteja conectado a tudo que você precisa para, saber sobre saídas
              de empregos para o curso que escolheu, instrutor virtual e
              econtrar a sua futura escola a um click!
            </p>
          </style.FutureDescripion>
          <span>
            <style.Cloud />
      ...
      <style.HighSchoolSection>
        ...
        <style.DescriptionHighSchoolSection>
          ...
          <p>
            ...
            Acreditamos que o acesso a educação pode mudar o mundo e trabalhamos
            para isso.
          </p>
        </style.DescriptionHighSchoolSection>
      </style.HighSchoolSection>
      ...
      <style.Question>
        ...
        <style.QuestionContent>
          ...
          <style.QuestionDescription>
            ...
            <label>
              <style.QuestionLink to="/faq">Vá para as FAQ</style.QuestionLink>
              <strong>ou</strong>
